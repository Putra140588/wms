     ...
     <div class="row">
     	<div class="col-lg-12">
     		<div class="panel panel-info">
     			...
     			<input type="hidden" name="id" value="<?php echo isset($id_jabatan) ? $id_jabatan : ''?>">
     			<?php $select='';?>
     				<div class="row">     				
     					<div class="col-lg-6">
	     					<div class="form-group">
	     						...
	     						<div class="controls">	     						
	     							<input class="form-control" type="text" name="namajabatan" placeholder="Nama Jabatan" value="<?php echo isset($nama_jabatan) ? $nama_jabatan : ''?>"  required>
