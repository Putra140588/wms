                			...
                			<div class="table-responsive">
                				<table class="table table-striped">
                					<tbody>
                						...
                						<tr><td><b>Alamat Pengiriman</b></td><td>:</td><td><?php echo $deliv[0]->alamat?></td></tr>
                						<tr><td><b>Alamat Penagihan</b></td><td>:</td><td><?php echo $bill[0]->alamat?></td></tr>
                			...
                			<div class="table-responsive">
                				<table class="table table-striped">
                					<tbody>
                						...
                						<tr>
                							<td><b>Qty Order</b></td><td>:</td><td><?php echo qty_format($qty_pcs)?></td>
                							<td><b>Security Cut</b></td><td>:</td><td><?php echo $security_cut?></td>
                						</tr>
                						<tr>
                							<td><b>Qty Roll</b></td><td>:</td><td><?php echo qty_format($qty_roll)?></td>
                							<td><b>Perforation</b></td><td>:</td><td><?php echo $perforation?></td>
                						</tr>
                						<tr>
                							<td><b>PC/Roll</b></td><td>:</td><td><?php echo qty_format($pcsroll)?></td>
         	...
         	<div class="panel panel-default">
         		...
         		<div class="panel-body">         			
         				<div class="form-group">
         					...
         					<input type="text" class="form-control" name="<?php echo base_url('bo/mpproduksi/enter_code/'.$id_kategori)?>"  id="keycode" placeholder="Entry / Scan Barcode" autocomplete="off">
         				</div>
         				<div class="form-group">
         			...
         			<div class="panel-body">
         				<div class="table-responsive">
		         			<table class="table table-striped table-bordered">
		         				...
		         				<tbody>
		         					 <?php 
		         					 $sliting = $this->m_master->get_sliting(array('A.ws_number'=>$ws_number));
									if (count($sliting) > 0){
										$no=1;
										foreach ($sliting as $row){
											echo '<tr>
														...
														<td>'.(int)$row->lebar_sliting.'</td>
														<td>'.(int)$row->tinggi_sliting.'</td>
														<td>'.(int)$row->qty_roll_sliting.'</td>
														<td>'.$row->qty_pcs_sliting.'</td>
														<td>'.$row->nama_depan.'</td>
														<td>'.$row->date_sliting.'</td>
                										<td>'.$row->date_add.'</td>						
														<td>'.$row->add_by.'</td>                										
												  </tr>';
										}
									}else{
										echo '<tr><td colspan=12><center> -- Data Sliter Kosong -- </td></tr>';
									}?>			 
		         				</tbody>
		         			</table>
		         		</div>
