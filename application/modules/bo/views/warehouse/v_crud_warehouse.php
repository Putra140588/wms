     ...
     <div class="row">
     	<div class="col-lg-12">
     		<div class="panel panel-info">
     			...
     			<input type="hidden" name="id" value="<?php echo isset($id_warehouse) ? $id_warehouse : ''?>">
     			<?php $select='';?>
     				<div class="row">     				
     					<div class="col-lg-6">
     						 
	     					<div class="form-group">
	     						<label> Nama Warehouse <span class="required">*</span></label>
	     						<div class="controls">	     						
	     							<input class="form-control" type="text" name="nama" placeholder="Nama Warehouse" onmouseover="this.focus();" value="<?php echo isset($nama_warehouse) ? $nama_warehouse : ''?>"  required>	     							
	     						</div>
	     					</div>	
	     					<div class="form-group">
	     						<label> Phone</label>
